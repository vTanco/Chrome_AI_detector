  ...
  static profiles = {
    openai: {
      ...
      spanishMarkers: [
        ...
        "en resumidas cuentas", "sin lugar a dudas", "fascinante mundo", "en el fascinante mundo",
        "es crucial comprender", "es crucial destacar", "a continuación exploraremos",
        "a continuación, exploraremos", "en primer lugar", "en segundo lugar",
        "aspectos fundamentales", "es importante recordar", "en resumen",
        "esta guía detalla", "componentes esenciales", "características clave",
        "comprender su función", "tomar las mejores decisiones", "perfil de usuario",
        "es ideal para procesos que requieren", "es especialmente crítica en",
        "es especialmente crítico en", "altos y estables", "¡presta atención a esto!",
        "presta atención a esto", "imagina que estás",
        "primer gran reto práctico", "reto práctico del curso", "primer gran reto",
        "os convertiréis en", "asumiréis el rol de", "actuaréis como",
        "vuestra misión será", "tendréis que diseñar", "tendréis que elaborar",
        "setup informático completo ideal", "setup informático",
        "diferentes perfiles de usuario", "presupuestos reales y ajustados",
        "presupuestos reales", "se realiza de forma individual",
        "nota final de esta evaluación", "de la nota final",
        "documentos clave adjuntos", "documentos clave",
        "documento donde debéis registrar", "justificar técnicamente por qué",
        "justificar técnicamente", "límites de presupuesto y las reglas",
        "leedlo atentamente antes de", "contiene todas las instrucciones",
      ...
      structuralPatterns: [
        ...
        /^[•\-\*]\s+[A-ZÁÉÍÓÚ][^:\n]{2,55}:\s+/m,
        /\b(os convertiréis en|asumiréis el rol de|actuaréis como|vuestra misión será|tendréis que diseñar)\b/i,
    ...
    anthropic: {
      ...
      spanishMarkers: [
        ...
        "resulta interesante notar", "resulta interesante destacar", "resulta interesante observar",
        "resulta interesante señalar", "resulta interesante considerar", "optimiza significativamente",
        "conviene puntualizar", "es importante matizar",
        ...
        "es menester", "cabe advertir", "discernir entre", "no obstante", "resulta crucial",
        "articulación entre", "comprensión holística", "teoría y praxis", "rigor metodológico",
        "conviene destacar", "conviene precisar", "cabe precisar", "perspectiva reflexiva",
    ...
    google: {
      ...
      spanishMarkers: [
        ...
        "no dudes en decírmelo", "si necesitas adaptar",
        "mide exactamente", "presentan ligeras desviaciones", "ligeras desviaciones",
        "difiere bastante de", "difiere bastante", "recto, preciso y limpio",
        "no respeta el ángulo", "no realiza la entrega", "no realiza el corte",
        "no realiza", "notable / sobresaliente", "suficiente / bien", "sin hacer",
        "dimensiones de la madera", "corte a inglete", "ángulo de 45º"
      ],
      englishMarkers: [
  ...
  static attributeText(text, lang = "es") {
    if (!text || text.trim().length < 12) {
      return {
        ...
        detectedFeatures: [],
        watermarkInfo: "Texto breve o sin firmas inequívocas."
      };
    }
